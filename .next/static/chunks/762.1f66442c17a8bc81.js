"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[762],{3762:function(e,t,n){n.r(t),n.d(t,{default:function(){return b}});var l=n(7437),r=n(3705),i=n(2214),s=n(2375),a=n(9930),c=n(3922),u=n(2265),o=n(8604),d=n(9322),h=n(1216),x=n(5637),y=n(2352),k=n(7180),f=n(5574),p=n(703),g=n(7746),m=n(9348),w=n(3751),v=e=>{let{editor:t,content:n}=e,r=(0,u.useCallback)(e=>{e.preventDefault();let n=t.getAttributes("link").href,l=window.prompt("URL",n);if(null===l||""===l.trim()){t.chain().focus().extendMarkRange("link").unsetLink().run();return}l.match(/^https?:\/\//i)||(l="http://"+l),t.chain().focus().extendMarkRange("link").setLink({href:l}).run()},[t]);return t?(0,l.jsx)("div",{className:"px-4 py-3 rounded-tl-md rounded-tr-md flex justify-between items-start gap-5 w-full flex-wrap border border-gray-700",children:(0,l.jsxs)("div",{className:"flex justify-start items-center gap-4 w-full lg:w-10/12 flex-wrap",children:[(0,l.jsx)("div",{className:"text-sky-400 mt-1",children:(0,l.jsx)("button",{onClick:e=>{e.preventDefault();let n=window.prompt("URL");n&&t.chain().focus().setImage({src:n}).run()},children:(0,l.jsx)(o.Z,{className:"w-5 h-5"})})}),(0,l.jsx)("button",{onClick:e=>r(e),className:t.isActive("link")?"is-active":"",children:(0,l.jsx)("p",{className:"text-sky-400",children:"Link"})}),(0,l.jsx)("button",{onClick:e=>{e.preventDefault(),t.chain().focus().unsetLink().run()},disabled:!t.isActive("link"),className:"text-sky-400",children:"Unlink"}),(0,l.jsx)("button",{onClick:e=>{e.preventDefault(),t.chain().focus().toggleBold().run()},className:t.isActive("bold")?"bg-sky-700 text-white p-2 rounded-lg":"text-sky-400",children:(0,l.jsx)(d.Z,{className:"w-5 h-5"})}),(0,l.jsx)("button",{onClick:e=>{e.preventDefault(),t.chain().focus().toggleItalic().run()},className:t.isActive("italic")?"bg-sky-700 text-white p-2 rounded-lg":"text-sky-400",children:(0,l.jsx)(h.Z,{className:"w-5 h-5"})}),(0,l.jsx)("button",{onClick:e=>{e.preventDefault(),t.chain().focus().toggleUnderline().run()},className:t.isActive("underline")?"bg-sky-700 text-white p-2 rounded-lg":"text-sky-400",children:(0,l.jsx)(x.Z,{className:"w-5 h-5"})}),(0,l.jsx)("button",{onClick:e=>{e.preventDefault(),t.chain().focus().toggleStrike().run()},className:t.isActive("strike")?"bg-sky-700 text-white p-2 rounded-lg":"text-sky-400",children:(0,l.jsx)(y.Z,{className:"w-5 h-5"})}),(0,l.jsx)("button",{onClick:e=>{e.preventDefault(),t.chain().focus().toggleHeading({level:1}).run()},className:t.isActive("heading",{level:1})?"bg-sky-700 text-white p-2 rounded-lg":"text-sky-400",children:(0,l.jsx)(k.Z,{className:"w-5 h-5"})}),(0,l.jsx)("button",{onClick:e=>{e.preventDefault(),t.chain().focus().toggleBulletList().run()},className:t.isActive("bulletList")?"bg-sky-700 text-white p-2 rounded-lg":"text-sky-400",children:(0,l.jsx)(f.Z,{className:"w-5 h-5"})}),(0,l.jsx)("button",{onClick:e=>{e.preventDefault(),t.chain().focus().toggleOrderedList().run()},className:t.isActive("orderedList")?"bg-sky-700 text-white p-2 rounded-lg":"text-sky-400",children:(0,l.jsx)(p.Z,{className:"w-5 h-5"})}),(0,l.jsx)("button",{onClick:e=>{e.preventDefault(),t.chain().focus().setCode().run()},className:t.isActive("code")?"bg-sky-700 text-white p-2 rounded-lg":"text-sky-400",children:(0,l.jsx)(g.Z,{className:"w-5 h-5"})}),(0,l.jsx)("button",{onClick:e=>{e.preventDefault(),t.chain().focus().undo().run()},className:t.isActive("undo")?"bg-sky-700 text-white p-2 rounded-lg":"text-sky-400 hover:bg-sky-700 hover:text-white p-1 hover:rounded-lg",children:(0,l.jsx)(m.Z,{className:"w-5 h-5"})}),(0,l.jsx)("button",{onClick:e=>{e.preventDefault(),t.chain().focus().redo().run()},className:t.isActive("redo")?"bg-sky-700 text-white p-2 rounded-lg":"text-sky-400 hover:bg-sky-700 hover:text-white p-1 hover:rounded-lg",children:(0,l.jsx)(w.Z,{className:"w-5 h-5"})})]})}):null},b=e=>{let{onChange:t,content:n}=e,[o,d]=(0,u.useState)(!1),[h,x]=(0,u.useState)(null),y=e=>{t(e)},k=(0,r.jE)({extensions:[i.Z,a.ZP.configure({openOnClick:!1,autolink:!0}),c.ZP.configure({allowBase64:!0}),s.Z],editorProps:{attributes:{class:"flex flex-col line-clamp-3 px-4 py-3 justify-start border-b border-r border-l border-gray-700 text-black items-start w-full gap-3 font-medium text-[16px] pt-4 rounded-bl-md  rounded-br-md outline-none"}},onUpdate:e=>{let{editor:t}=e;y(t.getHTML())}});return(0,l.jsxs)("div",{className:"w-full ml-1 px-0",children:[(0,l.jsx)(v,{editor:k,content:n}),(0,l.jsx)(r.kg,{style:{whiteSpace:"pre-line"},editor:k})]})}},8030:function(e,t,n){n.d(t,{Z:function(){return c}});var l=n(2265);/**
